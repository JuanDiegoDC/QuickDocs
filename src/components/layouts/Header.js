          ...
          <div style={{
            ...
            <Dialog title="Dialog With Actions" open={this.props.dialogCreateOpen}>
              ...
              <DialogContent>
                ...
                <TextField autoFocus margin="dense" id="docTitle" label="Document Name" type="text" fullWidth onChange={(e) => this.props.updatedocTitle(e)}/> {/* <DialogContentText>
                      Please enter password:
                    </DialogContentText> */
                }
                <TextField margin="dense" id="docPassword" label="Password" type="password" fullWidth onChange={(e) => this.props.updateDocPass(e)}/>
              </DialogContent>
              <DialogActions>

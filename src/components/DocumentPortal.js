                  ...
                  <TableBody>
                    {
                      this.state.documents.map(n => {
                        return (<TableRow hover="hover" key={n._id}>
                            ...
                            <Button onClick={() => this.toggleDialog()} variant="extendedFab">
                              ...
                              <Dialog title="Dialog With Actions" open={this.state.dialogOpen}>
                                ...
                                <DialogContent>
                                  ...
                                  <TextField autoFocus="autoFocus" margin="dense" id="docPassword" label="Password" type="password" fullWidth="fullWidth"/>
                                </DialogContent>
                                <DialogActions>
                          ...
                          {* /}
                          <TableCell>
                            <Button onClick={() => this.editDocument(event, n._id)} variant="extendedFab">edit</Button>
                          </TableCell>
                        </TableRow>);
                      })
                    }
